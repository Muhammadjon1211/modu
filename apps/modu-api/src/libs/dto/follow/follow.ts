...
export class MeFollowed {
	@Field(() => String) followerId: ObjectId;

	@Field(() => String) followingId: ObjectId;
...
export class Follower {
	...
	/** from aggregation **/
	@Field(() => Member, { nullable: true }) followerData?: Member;
...
export class Following {
	...
	/** from aggregation **/
	@Field(() => Member, { nullable: true }) followingData?: Member;
