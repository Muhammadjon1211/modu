...
export class Member {
	...
	@Field(() => String, { nullable: true }) memberShopName?: string;

	@Field(() => String, { nullable: true }) memberShopBanner?: string;

	@Field(() => [String], { nullable: true }) memberSocials?: string[];
	...
	@Field(() => Int) memberOrders: number;

	@Field(() => Int) memberSales: number;
...
/**
 * Declared once here and imported by every other list wrapper.
 * Redeclaring it would collide on the type name under autoSchemaFile.
 */
@ObjectType()
