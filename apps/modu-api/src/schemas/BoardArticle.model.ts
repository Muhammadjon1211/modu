...
const BoardArticleSchema = new Schema(
	{
		articleCategory: { type: String, enum: BoardArticleCategory, required: true },
		articleStatus: { type: String, enum: BoardArticleStatus, default: BoardArticleStatus.ACTIVE },
