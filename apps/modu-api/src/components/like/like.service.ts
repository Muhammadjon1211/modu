...
export class LikeService {
	...
	/** One method serves like and unlike: the caller feeds the modifier into its stats editor. */
	...
	/**
	 * Returns an array of zero or one element — the same shape `lookupAuthMemberLiked`
	 * produces in list queries, so the client has one code path.
	 */
	...
	/** the wishlist — built exactly like getVisitedProducts, over the `likes` collection */
